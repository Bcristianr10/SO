...
@section('title') Crear Emprendimiento @endsection
        ...
        <div class="col-md-12 col-xl-8 offset-xl-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('emprendimientos.insert')}}"  method="POST" role="form" autocomplete="off"  enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-12 ">
                                ...
                                <div class="">
                                    <input class="form-control" type="input" name="txtTitulo" id="example-password-input1"
                                        placeholder="Ingrese el titulo" value="" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 col-md-12 ">
                                ...
                                <div class="">
                                    <input class="form-control" type="input" name="txtTelefono" id="example-password-input1"
                                        placeholder="Ingrese su telefono" value="" required>
                                </div>
                            </div>
