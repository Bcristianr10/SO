...
@section('title') Emprendimientos @endsection
@section('css')
...
@section('content')
    @component('common-components.breadcrumb')
        @slot('title') Emprendimientos  @endslot
        ...
        <div class="col-md-10 offset-md-1">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <h4 class="card-title col-sm-4">Emprendimientos</h4>
                        <div class="col-sm-4 offset-sm-8">
                            
                            <a class="btn btn-primary waves-effect waves-light w-100" href="{{route('emprendimientos.create')}}">
                                ...
                                @foreach ($resultado as $fila)
                                    ...
                                    <tr>                                        
                                        ...
                                        <td>
                                                ...
                                                <a class="btn btn-primary btn-sm" href="{{route('emprendimientos.update',['id'=>$fila->id])}}">
                                            ...
                                            @include('modals.eliminarEmprendimiento') 
