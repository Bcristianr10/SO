        ...
        <div class="col-md-12 col-xl-8 offset-xl-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('adminBlog.save2')}}"  method="POST" role="form" autocomplete="off"  enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-12 ">
                                ...
                                <div class="">
                                    <input class="form-control" type="input" name="txtTitulo2" id="example-password-input1"
                                        placeholder="Titulo dos" value="{{$resultado->titulo_2}}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 col-md-12 ">
                                ...
                                <div class="col-lg-12" >
                                    <textarea class="form-control" id="elm1" rows="5" name="textoDos">{!!$resultado->texto_2!!}</textarea>
