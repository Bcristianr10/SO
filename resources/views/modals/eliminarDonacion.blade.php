            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="text-center col-md-12">
                            <h3>Desea Eliminar el Donacion de:</h3>
                            <h4>{{$fila->nombre}}</h4>
                        </div>
                        <br>
                        <br>
                        ...
                        <div class="col-md-2 offset-md-2 ">
                            <a class="btn btn-outline-danger btn-round w-100" href="{{route('donaciones.eliminar',['id'=>$fila->id])}}"><i class="fa fa-trash"></i> Eliminar</a>
                        </div>
