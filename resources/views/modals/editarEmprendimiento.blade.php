        ...
        <div class="modal-content">
            <div class="modal-header  text-white">
                <h5 class="modal-title align-self-center"
                    id="myLargeModalLabel">Editar Emprendimiento</h5>
                            ...
                            <div class="mb-3 col-md-12 ">
                                ...
                                <div class="">
                                    <input class="form-control" type="input" name="txtTitulo" id="example-password-input1"
                                        placeholder="Ingrese el titulo" value="{{$fila->titulo}}" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 col-md-12 ">
                                ...
                                <div class="">
                                    <input class="form-control" type="input" name="txtNombre" id="example-password-input1"
                                        placeholder="Ingrese un nombre" value="{{$fila->persona}}" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 col-md-12 ">
                                ...
                                <div class="">
                                    <input class="form-control" type="input" name="txtTelefono" id="example-password-input1"
                                        placeholder="Ingrese su telefono" value="{{$fila->telefono}}" required>
                                </div>
                            </div>
