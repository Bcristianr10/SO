        ...
        @foreach($resultado as $emprendimiento)
            <div class="col-md-6 col-lg-3">
                ...
                <div class="causes-footer">
                    <div class="admin">
                    <h5><a href="#"><span class="icon-img"><img src="{{asset('assets/images/icons/admin1.png')}}" alt="Icon"></span>{{$emprendimiento->persona}}</a></h5>
                    <h5 class="mr-t"><a href="#"><span class="icon-img"><img src="{{asset('assets/images/icons/call.png')}}" alt="Icon"></span>{{$emprendimiento->telefono}}</a></h5>
                    </div>
