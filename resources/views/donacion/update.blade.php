...
@section('title') Actualizar Donación @endsection
                            ...
                            <div class="mb-3 col-md-12 ">
                                ...
                                <div class="">
                                    <input class="form-control" type="number" name="txtMonto" id="example-password-input1"
                                        placeholder="Ingrese el monto" value="{{$resultado->monto}}" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 col-md-12 ">
                                ...
                                <div class="">
                                    <input class="form-control" type="input" name="txtNombre" id="example-password-input1"
                                        placeholder="Ingrese un nombre" value="{{$resultado->nombre}}" required>
                                </div>
                            </div>
